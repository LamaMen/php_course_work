    ...
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                @else
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle btn-rounded" type="button" id="dropdownMenuButton1"
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img alt="" src="https://flymonitor.ru/uploads/posts/2018-06/1528702059_img-20180610-wa0004.jpg"/>
            ...
            <div class="carousel-item">
                <img alt="" src="https://shelaputin.ru/wp-content/gallery/20130609m/img1699.jpg"/>
